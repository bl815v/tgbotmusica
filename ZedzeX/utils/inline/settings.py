    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="Calidad de audio", callback_data="AQ"
            ),
            InlineKeyboardButton(
                text="Calidad de video", callback_data="VQ"
            ),
        ],
        [
            InlineKeyboardButton(
                text="Administradores", callback_data="AU"
            ),
            InlineKeyboardButton(
                text="Modo limpio", callback_data="CM"
            ),
        ],
        [
            InlineKeyboardButton(
                text="Soporte", url=f"{SUPPORT_GROUP}",
            ),
            InlineKeyboardButton(
